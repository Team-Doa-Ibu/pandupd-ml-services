...
@pytest.mark.anyio
async def test_diagnosis_no_url():
...
@pytest.mark.anyio
async def test_vm_diagnosis_invalid_url():
...
@pytest.mark.anyio
async def test_vm_diagnosis_failed_download(httpserver: HTTPServer):
...
@pytest.mark.anyio
async def test_vm_diagnosis_success(httpserver: HTTPServer):
...
@pytest.mark.anyio
async def test_hw_diagnosis_success(httpserver: HTTPServer):
...
@pytest.mark.anyio
async def test_multi_modal_diagnosis_success(httpserver: HTTPServer):
...
@pytest.mark.anyio
async def test_multi_modal_diagnosis_one_fails(httpserver: HTTPServer):
